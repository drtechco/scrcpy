        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= AndroidVersions.API_31_ANDROID_12 && callMethodVersion == 0) {
                ...
                switch (callMethodVersion) {
                    case 1:
                        args = new Object[]{FakeContext.SHELL_PACKAGE_NAME, null, "settings", callMethod, arg, extras};
                        break;
                    case 2:
                        args = new Object[]{FakeContext.SHELL_PACKAGE_NAME, "settings", callMethod, arg, extras};
                        break;
                    default:
                        args = new Object[]{FakeContext.SHELL_PACKAGE_NAME, callMethod, arg, extras};
                        break;
                }
            }
